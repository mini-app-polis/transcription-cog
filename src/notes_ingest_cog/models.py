...
class NotesOutput(BaseModel):
    ...
    key_concepts: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    vocabulary_terms: list[dict[str, Any]] = Field(default_factory=list, description = 'TODO: describe this field.')
    drills: list[dict[str, Any]] = Field(default_factory=list, description = 'TODO: describe this field.')
    common_mistakes: list[dict[str, Any]] = Field(default_factory=list, description = 'TODO: describe this field.')
    patterns_and_sequences: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    student_observations: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    action_items: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    competition_notes: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    quotes: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    references: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    off_topic_notes: list[Any] = Field(default_factory=list, description = 'TODO: describe this field.')
    suggested_new_sections: list[dict[str, Any]] = Field(default_factory=list, description = 'TODO: describe this field.')
