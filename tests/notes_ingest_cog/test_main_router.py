"""Tests for the top-level router in ``notes_ingest_cog.main``.
...
from notes_ingest_cog import main as main_mod
from notes_ingest_cog.main import (
    _MODE_DISPATCH,
    NotesIngestMode,
    notes_ingest_router,
)
...
class TestRouterErrors:
    ...
    def test_unknown_mode_raises_value_error(self) -> None:
        ...
        """
        with pytest.raises(ValueError, match="Unknown notes-ingest-cog router mode"):
